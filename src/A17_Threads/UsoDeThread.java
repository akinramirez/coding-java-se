...
//3 - Instancias la clase creada y almacenar la instancia en variable de tipo Runnable
//4 - Crear instancia de la clase Thread pasando como parametro al constructor
...
//      }
    ...
    System.out.println("Estado del hilo despues de comenzar la tarea " + Thread.currentThread().isInterrupted());
